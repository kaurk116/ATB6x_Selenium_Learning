...
public class futurepedia {
    ...
    public void openEbayPage() throws InterruptedException {
        ...
        driver.get("https://www.toptools.ai/");
        ...
        List<WebElement> name =driver.findElements(By.xpath("//h2[@class=\"card_name\"]"));
        for(WebElement names :name){
            System.out.println(names.getText());
        }

        /*List<WebElement> dec =driver.findElements(By.xpath("//h2[@class=\"aitools-tool-description\"]"));
        for(WebElement description :dec){
            System.out.println(description.getText());
        }
*/

        List<WebElement> URL = driver.findElements(By.xpath("//a[@class=\"card_button w-inline-block\"]"));
